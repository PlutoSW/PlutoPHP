...
<head>
    ...
    <title><?php echo __('errors.401_title'); ?></title>
    <link
        rel="stylesheet"
...
<body class="d-flex w-100 h-100 justify-center items-center">
    <div class="d-flex flex-column self-center items-center w-50 border border-primary pb-3">
        <h1 class="text-primary-dark">401</h1>
        <h2 class="text-primary-dark"><?php echo __('errors.401_subtitle'); ?></h2>
        <p>
            <?php echo __('errors.401_description'); ?>
        </p>
        <a
